...
alight.component('bot-flow-root', function (scope, element, env) {
	    return { 
	    	template : `<div class="_c_b_app" :class.active="is_bot_open">
	<div class="_tpbr">
		...
		{{(test_bot ? 'Test Bot' : (bot_name ? bot_name : 'Help Assistance'))}}
	    	...
	    	onStart: function() {
	    			...
	    			scope.initVars = function() {  //vars
	    				...
	    				scope.uuid = (scope.test_bot ? ( (scope.Helper.getCookie(__c_b_app.env.cookie.uuid_key)) ? ("_test_" + scope.Helper.getCookie(__c_b_app.env.cookie.uuid_key)) : null) : (scope.Helper.getCookie(__c_b_app.env.cookie.uuid_key)));
