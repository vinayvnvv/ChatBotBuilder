...
var GetBotComponent = (function () {
    function GetBotComponent(rootScope, http, Strings, Models, Toast) {
        this.rootScope = rootScope;
        this.http = http;
